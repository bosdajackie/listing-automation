    ...
    if "OPENAI_API_KEY" in os.environ:
        try:
            ...
            prompt = (
                ...
                "- The vehicle must be centered, realistic, high-resolution, and uncropped, with pure white background\n"
                ...
                "- Use a colour that the vehicle was sold in or a popular colour that was sold\n\n"
                f"Here is the selected vehicle (if any): {selected_vehicle}\n"
                "If no selected vehicle was provided, please choose the most popular vehicle from the GIVEN vehicle list according to sales volume in the given year range.\n"
                "Make sure that you are not generating a generic car image, it has to be from the vehicle data list.\n"
                f"Here is the vehicle data:\n{vehicle_list}\n"
            )
